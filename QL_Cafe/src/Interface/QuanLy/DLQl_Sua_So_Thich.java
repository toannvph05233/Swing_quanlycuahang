 ...
 * @author ACER
 */
public class DLQl_Sua_So_Thich extends javax.swing.JDialog {
     ...
     */
     String MaSoThich;
    public DLQl_Sua_So_Thich(java.awt.Frame parent, boolean modal, String masothich) {
        super(parent, modal);
        initComponents();
        MaSoThich = masothich;
        SoThich l = cn.GetSoThichByMa(masothich);
        txtSoThich.setText(l.GetTenSoThich());
        lblten.setText("Sửa màu sắc - "+l.GetTenSoThich());
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtSoThich, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(166, 166, 166)
                        .addComponent(lblten)))
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        sothich.SetTenSoThich(txtSoThich.getText());
        sothich.SetMaSoThich(MaSoThich);
        int update = cn.UpdateSoThich(sothich);
        if(update > 0){
