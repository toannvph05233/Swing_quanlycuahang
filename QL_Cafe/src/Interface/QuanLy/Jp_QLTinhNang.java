 ...
 * @author ACER
 */
public class Jp_QLTinhNang extends javax.swing.JPanel {
    ConnectSQL cn = new ConnectSQL();
    /**
     * Creates new form Jp_QLTinhNang
     */
    public static Jp_QLTinhNang tinhnang;
    public Jp_QLTinhNang() {
        initComponents();
        tinhnang = this;
        FillTable();
    }
    ...
    public void FillTable() {
        ArrayList<TinhNang> arrTable = cn.GetTinhNang();
        ...
        if (arrTable != null) {
            int sotinhnang = 0;
            for (TinhNang l : arrTable) {
                sotinhnang++;
                tbmodel.addRow(new Object[]{l.GetMaTinhNang(), l.GetTenTinhNang()});
            }
            lblthongtin.setText(String.valueOf(sotinhnang)+" tính năng");
        } else {
            JOptionPane.showMessageDialog(null, "Không có tính năng nào");
        }
        tbTinhNang.setModel(tbmodel);
        for(int i = 0; i < tbTinhNang.getColumnCount();i++){
            Class<?> col = tbTinhNang.getColumnClass(i);
            tbTinhNang.setDefaultEditor(col, null);
        }        
    }
    ...
    private void initComponents() {
        ...
        tbTinhNang = new javax.swing.JTable();
        ...
        jLabel3.setText("Quản lý tính năng");
        ...
        jLabel2.setText("Tổng số tính năng:");
        ...
        tbTinhNang.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbTinhNangMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tbTinhNang);
    ...
    private void bntXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntXoaActionPerformed
        int[] selectedRows = tbTinhNang.getSelectedRows();

        if (selectedRows.length <= 0) {
            JOptionPane.showMessageDialog(null, "Bạn chưa chọntính năng !");
        } else {
            ArrayList<String> listmatinhnang = new ArrayList<String>();
            String sp = "";
            for (int i : selectedRows) {
                String ma = (String) tbTinhNang.getValueAt(i, 0);
                listmatinhnang.add(ma);
                String tentinhnang = (String) tbTinhNang.getValueAt(i, 1);

                sp += tentinhnang + "\n";
            }
            int qs;
            qs = JOptionPane.showConfirmDialog(null, "Xóa kiểu dáng: \n " + sp, "Xóa kiểu dáng", JOptionPane.YES_NO_OPTION);
            if (qs == JOptionPane.YES_OPTION) {
                boolean xoa = cn.DeleteTinhNang(listmatinhnang);
                ...
                JOptionPane.showMessageDialog(null, "Không xóa được tính năng !");
    ...
    private void txttimKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txttimKeyReleased
        ArrayList<TinhNang> arrTable = cn.SearchTinhNang(txttim.getText());
        if(arrTable != null){
            DefaultTableModel tbmodel = new DefaultTableModel();
            ...
            int sohang = 0;
            for (TinhNang b : arrTable) {
                sohang++;
                tbmodel.addRow(new Object[]{b.GetMaTinhNang(), b.GetTenTinhNang()});
            }
            tbTinhNang.setModel(tbmodel);
            for(int i = 0; i < tbTinhNang.getColumnCount();i++){
                Class<?> col = tbTinhNang.getColumnClass(i);
    ...
    private void bntThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntThemActionPerformed
        DLQl_Them_Tinh_Nang b = new DLQl_Them_Tinh_Nang(Run.QlCafe, true);
        b.setVisible(true);
    ...
    private void bntSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntSuaActionPerformed
        int select=tbTinhNang.getSelectedRow();
        if(select<0){
            JOptionPane.showMessageDialog(null, "Bạn chưa chọn tính năng !");
        }else{
            String matinhnang = (String) tbTinhNang.getValueAt(select, 0);

            DLQl_Sua_Tinh_Nang sua = new DLQl_Sua_Tinh_Nang(Run.QlCafe, true, matinhnang);
            sua.setVisible(true);
        }
    ...
    private void tbTinhNangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbTinhNangMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbTinhNangMouseClicked
    ...
    private javax.swing.JTable tbTinhNang;
