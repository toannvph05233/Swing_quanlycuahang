 ...
 * @author ACER
 */
public class DLQl_Sua_Kieu_Dang extends javax.swing.JDialog {
    ConnectSQL cn = new ConnectSQL();
    /**
     * Creates new form DLQl_Sua_Kieu_Dang
     * @param parent
     * @param modal
     */
    String MaKieuDang;
    public DLQl_Sua_Kieu_Dang(java.awt.Frame parent, boolean modal, String makieudang) {
        super(parent, modal);
        initComponents();
        MaKieuDang = makieudang;
        KieuDang l = cn.GetKieuDangByMa(makieudang);
        txtTenKieuDang.setText(l.GetTenKieuDang());
        lblten.setText("Sửa kiểu dáng - "+l.GetTenKieuDang());
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtTenKieuDang, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(166, 166, 166)
                        .addComponent(lblten)))
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        if(txtTenKieuDang.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Kiểu dáng không được để trống !");
            txtTenKieuDang.requestFocus();
            return;
        }

        KieuDang kieudang = new KieuDang();
        kieudang.SetTenKieuDang(txtTenKieuDang.getText());
        kieudang.SetMaKieuDang(MaKieuDang);
        int update = cn.UpdateKieuDang(kieudang);
        if(update > 0){
