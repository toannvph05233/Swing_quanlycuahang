            ...
            for(HangSanXuat l : arrLoai){
                    ...
                    btn.addMouseListener(new MouseAdapter() {
                        ...
                        public void mousePressed(MouseEvent e) {
                            ...
                            ArrayList<SanPham> arrThucDon = cn.GetThucDon(l.GetMaLoai());
                            jpChonMon.removeAll();
                            jpChonMon.updateUI();
                            if(arrThucDon != null){
